...
export const sampleCategories = [
  {
    ...
    name: "Bobinas",
    slug: "bobinas",
    description: "Bobinas de encendido, captoras y componentes asociados.",
    imageUrl: null,
    imagePublicId: null,
    sortOrder: 1,
    isFeatured: true,
  ...
  },
  {
    ...
    name: "Plaquetas",
    slug: "plaquetas",
    description: "Plaquetas reguladoras y modulos electricos.",
    imageUrl: null,
    imagePublicId: null,
    sortOrder: 3,
    isFeatured: false,
...
export const sampleProducts: SampleProduct[] = [
  ...
  },
  {
    ...
    categoryName: "Plaquetas",
    categorySlug: "plaquetas",
    isActive: true,
    isFeatured: false,
    images: [],
  },
